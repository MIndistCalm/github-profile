...
export const SearchForm = ({ loading = false, error, userData, onSearch, onShowRepos = () => {} }: SearchFormProps) => {
  return (
    <div className="max-w-2/3 w-full mx-auto mt-10 p-6 bg-white rounded-xl shadow-lg dark:bg-stone-700 dark:text-white">
      <h1 className="text-2xl font-bold text-center mb-6">GitHub Профиль</h1>
